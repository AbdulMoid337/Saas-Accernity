...
const Circle = React.forwardRef(({ className, children }, ref) => {
  return (
    <div 
      ref={ref} 
      className={cn(
        "z-10 flex h-10 w-10 items-center justify-center rounded-full  bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.16)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  const div2Ref = React.createRef();
  const div3Ref = React.createRef();
  const div4Ref = React.createRef();
  const div5Ref = React.createRef();
  const div6Ref = React.createRef();
  const div7Ref = React.createRef();
...
const Icons = {
  ...
  messenger: () => (
    ...
    >
      ...
      <path
        fill="#ffffff"
        d="M34.394,18.501l-5.7,4.22c-0.61,0.46-1.44,0.46-2.04,0.01L22.68,19.74	c-1.68-1.25-4.06-0.82-5.19,0.94l-1.21,1.89l-4.12,6.695c-0.6,0.94,0.55,2.01,1.44,1.34l5.7-4.22c0.61-0.46,1.44-0.46,2.04-0.01	l3.974,2.991c1.68,1.25,4.06,0.82,5.19-0.94l1.21-1.89l4.11-6.68C36.434,18.901,35.284,17.831,34.394,18.501z"
      />
    </svg>
  ),
};
